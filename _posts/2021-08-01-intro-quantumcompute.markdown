...
1 = α<sup>*</sup>α + β<sup>*</sup>β + γ<sup>*</sup>γ + δ<sup>*</sup>δ 
...
More complex relationships can be created from these, such as: 

H&#x2080;C<sub>NOT</sub> = C<sub>Z</sub>H&#x2080; 
