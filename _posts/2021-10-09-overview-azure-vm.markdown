...
The [HBv3](https://docs.microsoft.com/en-us/azure/virtual-machines/hbv3-series) series has a variety of SKUs varying from 16 to 12 AMD EPYC™ 7003 cores (without hyper-threading) and 448 GiB RAM. They support 350GBps memory bandwidth and a 200Gbps InfiniBand network allowing them to support supercomputer-scale MPI workloads.
